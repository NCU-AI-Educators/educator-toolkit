...
[![Version](https://vsmarketplacebadge.apphb.com/version/hawklee.md-styled-html-preview.svg)](https://marketplace.visualstudio.com/items?itemName=hawklee.md-styled-html-preview)
[![Installs](https://vsmarketplacebadge.apphb.com/installs-short/hawklee.md-styled-html-preview.svg)](https://marketplace.visualstudio.com/items?itemName=hawklee.md-styled-html-preview)
...
![Preview Demo](https://via.placeholder.com/800x400?text=Extension+Preview+Screenshot+Here)
*(Add a screenshot of your preview window here)*
...
2. **Preview**: Click the **Hawk Icon** (🦅) or **Eye Icon** in the editor title bar (top-right).
...
2. **预览**：点击编辑器右上角标题栏的 **Hawk 图标** (🦅) 或 **预览图标**。
